...
docs: ## generate Sphinx HTML documentation, including API docs
	rm -f docs/edider.rst
	rm -f docs/modules.rst
	sphinx-apidoc -o docs/ src/edider
	$(MAKE) -C docs clean
	$(MAKE) -C docs html
...
install: clean ## install the package to the active Python's site-packages - python3
	@echo "----------------------------------------"
	@echo -e "Installing edider - may need root\n\t `pip3 --version`"
	@echo "----------------------------------------"
...
install-user: ## install the package to the user's home directory - python3
	@echo "----------------------------------------"
	@echo -e "Installing edider for ${USER}\n\t `pip3 --version`"
	@echo "----------------------------------------"
...
uninstall: ## uninstall the package - python3
	@echo "----------------------------------------"
	@echo -e "Uninstalling edider - may need root\n\t `pip3 --version`"
	@echo "----------------------------------------"
	-pip3 uninstall edider

uninstall2: ## uninstall the package - python2
	@echo "----------------------------------------"
	@echo -e "Uninstalling edider - may need root\n\t `pip2 --version`"
	@echo "----------------------------------------"
	-pip2 uninstall edider
